...
from myshop.settings import REDIS_HOST
...
class Recommender:
    ...
    def suggest_products_for(self, products, max_results=6):
        ...
        if len(products) == 1:
            ...
            # Несколько товаров
            # Объединить баллы всех товаров, сохранить полученное мн-во в ключе 
            keys = [self.get_product_key(id) for id in product_ids]
            r.zunionstore(tmp_key, keys)
            # Удалить идентификаторы товаров по их количеству, сортировка по убыванию
